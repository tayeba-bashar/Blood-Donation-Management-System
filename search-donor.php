...
<div><textarea class="form-control" name="Gender"></textarea></div>
</div>
...
$gender=$_POST['Gender'];
$sql = "SELECT * from tblblooddonars where (status=:status and BloodGroup=:bloodgroup) AND  ((BloodGroup=:bloodgroup and Address=:location) OR (BloodGroup=:bloodgroup and Gender=:Gender))";
$query = $dbh -> prepare($sql);
